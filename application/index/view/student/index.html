...
<html lang="zh-cn">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Static &amp; Dynamic Tables								</small>							</h1>
						</div><!-- /.page-header -->
  ...
  <td>{$student.name}</td>
  <td>{$student.sex}</td>
  <td class="hidden-480">{$student.num}</td>
  <td>民传*</td>
  <td>{$student.klass_id}</td>
    ...
    <div class="hidden-md hidden-lg">
      <div class="inline pos-rel">
        ...
        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
          <li> <a href="#" class="tooltip-info" data-rel="tooltip" title="" data-original-title="View"> <span class="blue"> <i class="ace-icon fa fa-search-plus bigger-120"></i> </span> </a> </li>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 table-responsive">
          <table class="table table-bordered table-condensed">
            <tr >
              <td rowspan="13" style="width:100px" >无图</td>
              <td><i class="fa fa-user light-orange bigger-110"></i>{$student.name}<span class="label label-sm label-primary arrowed arrowed-right">{$student.sex}</span></td>
            </tr>
            <tr>
              <td><i class="fa fa-book light-orange bigger-110"></i> 民传*</td>
            </tr>
            <tr>
              <td><i class="fa fa-home light-orange bigger-110"></i> {$student.klass_id}</td>
            </tr>
            <tr>
              <td><i class="fa fa-info light-orange bigger-110"></i> {$student.num}</td>
            </tr>
            <tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.num}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.phone}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.father_name}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.mother_name}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.grade}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.id_card}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.account}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.location}</td>
            </tr>
			<tr>
              <td><i class="fa fa-phone light-orange bigger-110"></i> {$student.address}</td>
            </tr>
          </table>
        </div>
      </div>
